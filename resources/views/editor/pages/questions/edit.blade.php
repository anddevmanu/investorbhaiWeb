...
@section('title')
    <title>Edit Question - Investorbhai</title>
@endsection

@section('content')
    <div class="container mx-auto px-4">
        <div class="flex justify-between mb-6">
            <h1 class="text-3xl font-semibold text-gray-800">Edit Question</h1>
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            <form action="{{ route('question.update', $question->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Question Title -->
                    <div>
                        <label for="title" class="block text-gray-700">Question Title<span
                                class="text-red-500">*</span></label>
                        <input type="text" id="title" required name="title"
                            class="mt-1 p-3 block w-full border border-gray-300 rounded-md shadow-sm @error('title') border-red-500 @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            @php
                                $tagsArray = is_array($question->tags)
                                    ? $question->tags
                                    : json_decode($question->tags, true);
                    ...
                    <!-- Question Status -->
                    <div>
                        <label for="status" class="block text-gray-700">Question Status <span
                                class="text-red-500">*</span></label>
                        <select id="status" required name="status"
                            class="mt-1 p-3 block w-full border border-gray-300 rounded-md shadow-sm @error('status') border-red-500 @enderror">
                ...
                <div class="flex justify-center mt-6">
                    <button type="submit"
                        ...
                        <i class="fas fa-check"></i> Update Question
                    </button>
                </div>
            </form>
        </div>
