...
<div class="container mx-auto px-4">
    ...
    <div class="flex justify-between mb-6">
        <h1 class="text-3xl font-semibold text-gray-800">Create Blog</h1>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="title" required name="title" class="mt-1 p-3 block w-full border border-gray-300 rounded-md shadow-sm @error('title') border-red-500 @enderror" placeholder="Enter your blog title" value="{{ old('title') }}">
                        @error('title')
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="meta_title" required name="meta_title" class="mt-1 p-3 block w-full border border-gray-300 rounded-md shadow-sm @error('meta_title') border-red-500 @enderror" placeholder="Enter SEO meta title" value="{{ old('meta_title') }}">
                        @error('meta_title')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="meta_keywords" required name="meta_keywords" class="mt-1 p-3 block w-full border border-gray-300 rounded-md shadow-sm @error('meta_keywords') border-red-500 @enderror" placeholder="Enter SEO meta keywords">{{ old('meta_keywords') }}</textarea>
                        @error('meta_keywords')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <textarea id="meta_description" required name="meta_description" class="mt-1 p-3 block w-full border border-gray-300 rounded-md shadow-sm @error('meta_description') border-red-500 @enderror" placeholder="Enter SEO meta description">{{ old('meta_description') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="tags" required name="tags" class="mt-1 p-3 block w-full border border-gray-300 rounded-md shadow-sm @error('tags') border-red-500 @enderror" placeholder="Enter tags separated by commas" value="{{ old('tags') }}">
                        @error('tags')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="file" id="image" required name="image" class="mt-1 p-3 block w-full border border-gray-300 rounded-md shadow-sm @error('image') border-red-500 @enderror">
                        @error('image')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
