            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-blog"></i> Edit Blog
                    </h6>
                </div>
                <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="meta_title" required name="meta_title" class="form-control @error('meta_title') is-invalid @enderror" placeholder="Enter SEO meta title" value="{{ old('meta_title', $blog->seo->meta_title) }}">
                                            @error('meta_title')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea id="meta_keywords" required name="meta_keywords" class="form-control @error('meta_keywords') is-invalid @enderror" placeholder="Enter SEO meta keywords">{{ old('meta_keywords', $blog->seo->meta_keywords) }}</textarea>
                                            @error('meta_keywords')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea id="meta_description" required name="meta_description" class="form-control @error('meta_description') is-invalid @enderror" placeholder="Enter SEO meta description">{{ old('meta_description', $blog->seo->meta_description) }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="tags" required name="tags" class="form-control @error('tags') is-invalid @enderror" placeholder="Enter tags separated by commas" value="{{ old('tags', $blog->tags) }}">
                                            @error('tags')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            @if($blog->image)
                                                <div class="mt-2">
                                                    <img src="{{ asset($blog->image) }}" alt="Blog Image" class="img-thumbnail" width="200" height="200px">
                                                </div>
                                            @endif
                                            @error('image')
                                            <div class="invalid-feedback">{{ $message }}</div>
