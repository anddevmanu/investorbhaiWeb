...
@section('title')
    <title>Investorbhai - Simple Interest Calculator</title>
@endsection

@section('content')
<div class="main_content_wrapper p-4">
    <!-- Content for the left side -->
    <h3 class="page-header border-b pb-2 mb-3">Simple Interest Calculator</h3>

    <!-- Flex container for form and result -->
    <div class="flex flex-col lg:flex-row">
        <!-- Simple Interest Calculator Form -->
        ...
        <div id="result" class="bg-white p-6 mt-4 lg:mt-0 lg:ml-4 rounded-lg shadow-md w-full lg:w-1/2 hidden">
            ...
            <p id="interest-result" class="text-gray-700 mt-2">Simple Interest: <span class="font-semibold" id="simple-interest"></span></p>
            <p class="text-gray-700 mt-2">Total Amount (Principal + Interest): <span class="font-semibold" id="total-amount"></span></p>
        </div>
    </div>
</div>

<!-- Script to handle the calculation and validation -->
<script>
$(document).ready(function() {
    $('#simple-interest-form').on('submit', function(event) {
        ...
        if (isValid) {
            ...
            // Display the result
            $('#simple-interest').text(simpleInterest.toFixed(2));
